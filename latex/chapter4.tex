...
%	Taking into consideration the proposed architecture and the implementation of its components, it is important to infer whether it meets the requirements.
