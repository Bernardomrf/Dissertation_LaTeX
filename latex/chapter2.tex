...
Regarding to Thread standard, as addressed before, is an \ac{ipv6} based protocol, that like ZigBee is based on IEEE 802.15.4. Although this protocol was created for smart houses, Thread Group is expanding its connectivity to the buildings sector. 
